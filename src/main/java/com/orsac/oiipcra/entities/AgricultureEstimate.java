...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "agriculture_estimate")
public class AgricultureEstimate {
    @Id
    @SequenceGenerator(name = "agriculture_estimate_sequence", sequenceName = "agriculture_estimate_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "agriculture_estimate_sequence")
    @Column(name = "id")
    private Integer id;
