...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "fard_estimate")
public class FardEstimate {
    @Id
    @SequenceGenerator(name = "fard_estimate_sequence", sequenceName = "fard_estimate_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "fard_estimate_sequence")
    @Column(name = "id")
    private Integer id;
