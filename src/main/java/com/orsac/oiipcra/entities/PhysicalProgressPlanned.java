...
@NoArgsConstructor
@Entity
@Table(name = "physical_progress_planned")
public class PhysicalProgressPlanned {

    @Id
    @SequenceGenerator(name = "physical_progress_planned_sequence", sequenceName = "physical_progress_planned_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "physical_progress_planned_sequence")
    @Column(name = "id")
    private Integer id;
