...
@AllArgsConstructor
@Entity
@Table(name = "physical_progress_executed_log")
public class PhysicalProgressExecutedLog {
    @Id
    @SequenceGenerator(name = "physical_progress_executed_log_sequence", sequenceName = "physical_progress_executed_log_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "physical_progress_executed_log_sequence")
    @Column(name = "id")
    private Integer id;
    @Column(name = "tank_id")
